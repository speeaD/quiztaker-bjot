      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6">
        ...
        {mode === "exam" ? (
          <div className="flex items-center gap-2 sm:gap-3">
            <span className="hidden rounded-md bg-[#edf3ef] px-3 py-2 text-sm font-black text-[#0d3b2e] sm:block">
              {timer}
            </span>
            {onCalculatorToggle && (
              <button
            ...
            <button
              onClick={onSubmit}
              className="inline-flex items-center gap-2 rounded-md bg-[#b85b26] px-3 py-2 text-xs font-bold text-white transition hover:bg-[#99471a]"
            >
              <Send size={14} />
              Submit
            </button>
          ...
          <Link
            href={homeHref}
            className="inline-flex items-center gap-2 rounded-md px-3 py-2 text-xs font-bold text-[#15513e] hover:bg-[#edf3ef]"
          >
