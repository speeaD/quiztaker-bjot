...
export default function RegisterPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-background/50 via-white to-muted/50">
            {/* Header */}
            ...
            <main className="max-w-7xl mx-auto px-4 py-12">
                <div className="bg-card rounded-2xl shadow-card-xl p-8 md:p-12">
                    {/* Welcome Section */}
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-3 border border-input/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed"
                                    disabled={isLoading}
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground/50 w-5 h-5" />
                                <input
                                    type="text"
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <Phone className="absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground/50 w-5 h-5" />
                                <input
                                    type="tel"
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <School className="absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground/50 w-5 h-5" />
                                <select
                                    value={department}
                                    onChange={(e) => setDepartment(e.target.value)}
                                    className="w-full pl-10 pr-4 py-3 border border-input/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-transparent appearance-none disabled:opacity-50 disabled:cursor-not-allowed"
                                    disabled={isLoading}
                                >
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <BookOpen className="absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground/50 w-5 h-5" />
                                <input
                                    type="text"
                            ...
                            <div className="flex items-center gap-6">
                                <label className="flex items-center gap-2">
                                    <input
                                        ...
                                        className="rounded border-input/50 text-primary/700 focus:ring-primary/20"
                                        disabled={isLoading}
                                    />
                        ...
                        {!firstJamb && (
                            <div>
                                ...
                                <div className="relative">
                                    <ClipboardList className="absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground/50 w-5 h-5" />
                                    <input
                                        type="number"
                                        min="0"
                                        max="400"
                        ...
                        <div>
                            ...
                            <div className="flex items-center justify-between mb-3">
                                <p className="text-sm text-muted-foreground">
                                    Selected: <span className="font-semibold text-primary">{selectedQuestionSets.length}/4</span>
                                </p>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-h-96 overflow-y-auto border border-input/50 rounded-lg p-4 bg-muted/50">
                                {questionSets.map((qs) => (
                                    <label
                                        key={qs._id}
                                        className={`flex items-center p-4 rounded-lg cursor-pointer transition-all ${selectedQuestionSets.includes(qs._id)
                                            ? 'bg-primary/10 border-primary/20 text-primary shadow-md transform scale-105'
                                            : 'bg-white border-2 border-input/20 hover:border-primary/300 hover:shadow-sm'
                                            }`}
                                    >
                                        <input
                                            type="checkbox"
                                            ...
                                            className="rounded border-input/50 mr-3"
                                        />
                                        <div className="flex-1 min-w-0">
                                            <p className={`font-medium text-md truncate ${selectedQuestionSets.includes(qs._id) ? 'text-white' : 'text-foreground'
                                            }`}>
                                                {qs.title}
                                            </p>
                                        </div>
                                        {selectedQuestionSets.includes(qs._id) && (
                                            <span className="ml-2 px-2.5 py-1 bg-white text-primary text-xs font-bold rounded-full">
                        ...
                        <button
                            ...
                            className="w-full py-4 bg-primary text-primary-foreground rounded-lg font-semibold text-lg hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2 shadow-lg hover:shadow-xl"
                        >
                            {isLoading ? (
                                <>
